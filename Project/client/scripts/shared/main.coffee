...
.controller('AppCtrl', [
  ...
  ($scope, $location) ->
    $scope.isSpecificPage = ->
      path = $location.path()
      return _.contains([
        '/404', '/pages/500', '/pages/login', '/pages/signin', '/pages/signin1', '/pages/signin2', '/pages/signup',
        '/pages/signup1', '/pages/signup2', '/login', '/signup', '/getting-started', '/getting-started-student',
        '/401', '/500', '/'
      ], path)
